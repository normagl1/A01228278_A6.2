...
class Hotel:
    ...
    @staticmethod
    def display_hotel_information(name):        
    ...
    @staticmethod
    def reserve_a_room(hotel_name, room_number):        
    ...
    @staticmethod
    def cancel_a_reservation(hotel_name, room_number): 
        hotel = Hotel.load_from_file(f"{hotel_name}.json")
...
class Reservation:
    ...
    @staticmethod
    def create_reservation(customer_id,hotel_name,room_number,start_date,end_date):                
    ...
    @staticmethod
    def cancel_reservation(customer_id, hotel_name,room_number):
...
class Customer:
    ...
    @staticmethod
    def create_customer(customer_id, name,contact):        
            ...
            while True:
                ...
                if choice == "7":
                    ...
                    while name and not name_pattern.match(name):
                        print("Invalid name. Please enter only letters.")
                        name = input("Enter hotel name to display: ")
                    Hotel.display_hotel_information(name)
                elif choice == "4":
                    ...
                    while not rooms_pattern.match(room_number):
                        print("Invalid rooms number. Please enter a number with up to 4 digits.")
                        room_number = input("Enter room number to reserve: ")
                    Hotel.reserve_a_room(hotel_name, room_number)
                elif choice == "6":
                    name_pattern = re.compile(r'^[A-Za-z\s]+$')  # Acepta letras y espacios
                    rooms_pattern = re.compile(r'^\d{1,4}$')  # Rooms pattern
                    hotel_name =  input("Enter hotel name to delete: ")
                    ...
                    while not rooms_pattern.match(room_number):
                        print("Invalid rooms number. Please enter a number with up to 4 digits.")
                        room_number = input("Enter room number to reserve: ")  
                    Hotel.cancel_a_reservation(hotel_name, room_number)
                else:
            ...
            while True:
                ...
                if choice == "5":
                    ...
                    while not contact_pattern.match(contact):
                        print("Invalid contact. Please enter a number with up to 10 digits.")
                        contact = input("Enter customer contact: ")
                    Customer.create_customer(customer_id,name,contact)
                elif choice == "2":
                    customer_id_pattern = re.compile(r'^\d+$') 
                    customer_id = input("Enter customer ID: ")
                    while not customer_id_pattern.match(customer_id):
                    ...
                    while not customer_id_pattern.match(customer_id):
                        print("Invalid customer ID. Please enter only numbers.")
                        customer_id = input("Enter customer ID: ")
                    Customer.display_customer_information( customer_id)
                elif choice == "4":
            ...
            while True:
                ...
                if choice == "3":
                    ...
                    if end_date_dt <= start_date_dt:
                        ...
                        return
                    Reservation.create_reservation(customer_id,hotel_name,room_number, start_date, end_date)
                    pass
                elif choice == "2":
                    customer_id_pattern = re.compile(r'^\d+$')  # Expresión regular para verificar que solo contiene números
                    hotelname_pattern = re.compile(r'^[A-Za-z\s]+$')  # Acepta letras y espacios
                    ...
                    while not rooms_pattern.match(room_number):
                        print("Invalid rooms number. Please enter a number with up to 4 digits.")
                        room_number = input("Enter number of rooms: ")
                    Reservation.cancel_reservation(customer_id,hotel_name,room_number)
                    pass
                else:
